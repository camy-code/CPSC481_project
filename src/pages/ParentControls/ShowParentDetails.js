...
const ShowDetails = () => {
  ...
  const handleRestrictConfirm = () => {
    // Here you would typically save the restrictions to your backend
    console.log(`Restricting ${title} for profiles:`, selectedProfiles);
    setRestrictedProfiles([...selectedProfiles]);
